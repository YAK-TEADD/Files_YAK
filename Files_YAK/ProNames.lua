...
DevALS:set(YAK.."ALS:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌯︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevALS:get(YAK.."ALS:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevALS:get(YAK.."ALS:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevALS:get(YAK.."ALS:ProNames:Num"..msg.chat_id_) or 5
...
if DevALS:get(YAK.."ALS:Lock:ProNames"..msg.chat_id_) and DevALS:get(YAK.."ALS:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevALS:get(YAK.."ALS:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevALS:srem(YAK..'ALS:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevALS:get(YAK.."ALS:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevALS:get(YAK.."ALS:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
DevALS:del(YAK.."ALS:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevALS:set(YAK.."ALS:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌯︙تم تعطيل توحيد المجموعه')
DevALS:del(YAK.."ALS:Lock:ProNames"..msg.chat_id_)
end
end
