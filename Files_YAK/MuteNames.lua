...
if DevALS:get(YAK.."ALS:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevALS:sadd(YAK.."ALS:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevALS:get(YAK.."ALS:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
YAKName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if YAKName then 
YAKNames = DevALS:smembers(YAK.."ALS:Mute:Names"..msg.chat_id_) or ""
if YAKNames and YAKNames[1] then 
for i=1,#YAKNames do 
if YAKName:match("(.*)("..YAKNames[i]..")(.*)") then 
...
DevALS:set(YAK.."ALS:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevALS:del(YAK.."ALS:Lock:MuteNames"..msg.chat_id_)
end
end
end
